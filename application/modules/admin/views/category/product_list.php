                        ...
                        <div class="card-body"> 
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select onchange="selectCategory(this,0);" class="form-control regInputs" data-title="Category" id="category" name="parent_id[]">
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <input type="text" id="name" class="form-control mb-4 regInputs" name="name" placeholder="Product Name" data-title="Product Name">
                                    <p class="errorPrint" style="margin-top: -20px;" id="nameError"></p>
                                </div>
                                <div class="col-md-12 mt-2">
                                    <label>Product Price</label>
                                    <input type="number" id="price" class="form-control mb-4 regInputs" name="price" placeholder="Product Price" data-title="Product Price">
                                    <p class="errorPrint"  style="margin-top: -20px;" id="priceError"></p>
                                </div>
                                <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="table-responsive table-image">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php $sr=1; if ($product_list): foreach ($product_list as $list): ?>
                                            <tr>
                                                <td><?=$sr;?></td>
                                                <td><?= $list['name']; ?></td>
                                                <td><?= $list['price']; ?></td>
                                                ...
                                                <td>
                                                    <a style="cursor:pointer;" onclick="deleleProduct(this, <?= $list['product_id'] ?>);" class="composemail"><i class="fa fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        <?php
                                        $sr++;
...
<script type="text/javascript">
    function deleleProduct(obj, id) {
        var r = confirm("Are you sure to delete!");
        if (r == true) {
            if (id) {
                var reg_form_data = new FormData();
                reg_form_data.append("product_id",id);
                $.ajax({
