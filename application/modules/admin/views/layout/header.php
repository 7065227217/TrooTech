...
<head>
    ...
    <title>TrooTech Admin Panel </title>
            ...
            <nav class="navbar blue-bg navbar-static-top"> 
              ...
              <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                  <li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">  <span class="hidden-xs">Admin</span> <img src="<?php echo site_url();?>assets/admin/images/user.png" class="user-image" alt="User Image"></a>
